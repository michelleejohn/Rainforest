...
# Load Carattere font
carattere_font = pygame.font.Font('Carattere.ttf', 20)
...
# Outfit layout: 2 columns, dynamic rows to fit all outfits
num_outfits = len(outfit_images)
cols = 2
rows = (num_outfits + cols - 1) // cols  # ceiling division
...
outfit_offset_x = 0
outfit_offset_y = -10  # example: moves outfit 10 px up for better alignment
